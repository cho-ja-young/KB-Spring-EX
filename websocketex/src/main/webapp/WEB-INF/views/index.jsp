...
<%--        <input id="roomName" placeholder="방 이름" required />--%>
<%--        <input id="headCount" placeholder="최대 인원" required />--%>
<%--        <button type="submit">방 만들기</button>--%>
<%--    </form>--%>
<%--    <ul id="room-list" class="room-list"></ul>--%>
<%--</div>--%>

<%--<script src="<c:url value="/resources/js/stomp-index.js"/>"></script>--%>
<%--</body>--%>
<%--</html>--%>
...
<%--        <input type="text" id="roomName" class="form-control" placeholder="방 이름">--%>
<%--        <input type="text" id="headCount" class="form-control" placeholder="최대 인원">--%>
...
<%--        <input type="text" id="content" placeholder="메시지 입력" class="form-control"/>--%>
